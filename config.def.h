...
static const unsigned int gappoh    = 30;       /* horiz outer gap between windows and screen */
static const unsigned int gappov    = 30;       /* vert outer gap between windows and screen */
